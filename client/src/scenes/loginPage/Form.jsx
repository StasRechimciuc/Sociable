...
const Form = () => {
  ...
  const login = async (values, onSubmitProps) => {
    const loggedInResponse = await fetch(
      "https://sociable-demo.onrender.com/auth/login",
      {
        method: "POST",
  ...
  return (
    <Formik
      ...
      initialValues={
        isLogin || isDemo ? initialValuesLogin : initialValuesRegister
      }
      validationSchema={isLogin || isDemo ? loginSchema : registerSchema}
    >
      {({
        values,
        errors,
            ...
            {isDemo && (
              ...
              >
                <FlexBetween>
                  ...
                  >
                    Please,use gmail: demo@example.com
                  </Typography>
                </FlexBetween>
